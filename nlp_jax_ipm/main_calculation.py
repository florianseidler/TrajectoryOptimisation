...
def main_calculation(outer_iteration_variable, inner_iteration_variable, objective_function, cost_function,
                     equality_constraints, inequality_constraints, weights, slacks, lagrange_multipliers, num_weights,
                     num_equality_constraints, num_inequality_constraints, diagonal_shift_val, init_diagonal_shift_val,
                     armijo_val, verbosity, power_val, barrier_val, merit_function_parameter,
    ...
    """
    Computes search direction, updates merit function parameter and uses backtracking line search to find a better
    minimum and calculates the updated kkt-conditions.

    Parameters
    ----------
    outer_iteration_variable, inner_iteration_variable, objective_function, cost_function, equality_constraints,
    inequality_constraints, weights, slacks, lagrange_multipliers, num_weights, num_equality_constraints,
    num_inequality_constraints, diagonal_shift_val, init_diagonal_shift_val, armijo_val, verbosity, power_val,
    barrier_val, merit_function_parameter, merit_function_initialization_parameter,
    update_factor_merit_function_parameter, backtracking_line_search_parameter, weight_precision_tolerance, minimal_step

    Returns
    -------
    weights, slacks, lagrange_multipliers, barrier_val, kkt_weights, kkt_slacks, kkt_equality_lagrange_multipliers,
    ...
    if num_inequality_constraints:
        ...
        weights, slacks, lagrange_multipliers = \
            backtracking_line_search(cost_function, weights, slacks, lagrange_multipliers, search_direction,
                                     ...
                                     merit_function_parameter, minimal_step, equality_constraints,
    ...
    return weights, slacks, lagrange_multipliers, barrier_val, kkt_weights, kkt_slacks, \
